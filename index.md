...
:root {
  ...
  --vp-home-hero-name-background: linear-gradient(135deg, #00f3ff 0%, #bc13fe 100%);
  --vp-home-hero-image-filter: drop-shadow(0 0 50px rgba(0, 243, 255, 0.3));
}
</style>
